...
public class PageUtil {
    ...
    public String pager() {
        ...
        sb.append(String.format("<a href='?pageIndex=%d%s'>처음</a>", 1, addQueryString));
        sb.append(System.lineSeparator());
        sb.append(String.format("<a href='?pageIndex=%d%s'>이전</a>", previousPageIndex, addQueryString));
        sb.append(System.lineSeparator());
        ...
        sb.append(String.format("<a href='?pageIndex=%d%s'>다음</a>", nextPageIndex, addQueryString));
        sb.append(System.lineSeparator());
        sb.append(String.format("<a href='?pageIndex=%d%s'>마지막</a>", totalBlockCount, addQueryString));
        sb.append(System.lineSeparator());
